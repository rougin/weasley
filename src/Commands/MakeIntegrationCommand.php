...
class MakeIntegrationCommand extends \Symfony\Component\Console\Command\Command
{
    /**
    ...
    {
        $stub = file_get_contents(__DIR__ . '/../Templates/Integration.stub');
