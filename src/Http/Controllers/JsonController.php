...
class JsonController extends BaseController
{
     ...
     * @param \Valitron\Validator                      $valitron
     */
    public function __construct(ServerRequestInterface $request, ResponseInterface $response/*, Validator $valitron*/)
    {
        $this->check('model');
        ...
        // $this->validation = new $this->validator($valitron);
